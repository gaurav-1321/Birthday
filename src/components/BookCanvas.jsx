                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Ashna<span className="underline"></span>
                        </h4>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, Ashna!</article>
                            <article style={{ marginBottom: '10px' }}>I hope this year brings you infinite joy, laughter, and success.</article>
                            <article style={{ marginBottom: '10px' }}>Hoping for your better future, and wishing that you always have a good life and a happy life ahead.</article>
                            <article style={{ marginBottom: '10px' }}>Thank you for being such a wonderful friend—may all your dreams come true!</article>
                        </div>
